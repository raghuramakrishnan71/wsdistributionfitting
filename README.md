...
Calculates the skewness and kurtosis value of given data. Internally uses ReadDataFromFile methods. Works on each webservice of WSDREAM. Prior to using modify the directory in cd('') to point to location where the csv files reside.
